...
const BARBERS = [
  { id: 'b1', name: 'Petrovick', avatar: 'https://placehold.co/100x100/1F2937/EAB308?text=E', specialty: 'Cortes Clássicos', rating: 4.9, experience: '15 anos' },
    ...
    <div className="font-inter text-white min-h-screen relative">
      ...
      <div className="bg-black bg-opacity-30 backdrop-blur-md p-8 rounded-lg shadow-xl w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <p className="text-white mt-2">Faça login para acessar o painel administrativo</p>
        </div>
...
const Home = ({ onBookNow, services, barbers }) => {
  ...
  <div className="animate-fade-in space-y-4 sm:space-y-6 p-4 sm:p-6">
      ...
      <p className="text-white text-sm sm:text-base">Onde tradição e estilo se encontram. Agende seu horário com os melhores.</p>
      <button
        onClick={onBookNow}
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-400">Rua Professor Brasilio Barni<br />ZL - São Paulo/SP</p>
            </div>
          </div>
          <div className="flex items-center">
    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div>
        ...
        {myBookings.length > 0 ? (
          ...
          <p className="text-white bg-black bg-opacity-30 backdrop-blur-sm p-4 rounded-lg">Você ainda não tem nenhum agendamento.</p>
        )}
      </div>
      ...
      <div className="bg-black bg-opacity-25 backdrop-blur-md p-6 rounded-lg shadow-xl">
        ...
        <div className="space-y-2">
          {stats.revenueByBarber.length > 0 ? stats.revenueByBarber.map(([name, revenue]) => (
            ...
            <p className="text-white">Nenhum dado no período.</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-black bg-opacity-25 backdrop-blur-md p-4 sm:p-6 rounded-lg shadow-xl">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs sm:text-sm text-white">Total de Serviços</p>
        ...
        <div className="bg-black bg-opacity-25 backdrop-blur-md p-4 sm:p-6 rounded-lg shadow-xl">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-xs sm:text-sm text-white">Avaliação Média</p>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-700 p-4 rounded-lg space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-white mb-2">Início</label>
              <input
                type="time"
                value={startTime}
            ...
            <div>
              <label className="block text-sm font-medium text-white mb-2">Término</label>
              <input
                type="time"
                value={endTime}
          ...
          <div className="bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <form onSubmit={handleServiceSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-white mb-2">Nome do Serviço</label>
                  <input
                    type="text"
          ...
          <div className="bg-gray-800 rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <form onSubmit={handleBarberSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-white mb-2">Especialidades (separadas por vírgula)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-white mb-2">Avaliação (1-5)</label>
                  <input
                    type="number"
                    min="1"
                    max="5"
